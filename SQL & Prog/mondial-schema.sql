-- Mise en place du schéma Mondial
DROP schema if exists Mondial cascade;
CREATE schema Mondial;
set search_path to Mondial;

-- Création des tables (46 tables et un type GeoCoord)
...
-- Création de type GeoCoord

CREATE TYPE GeoCoord AS
(Latitude DECIMAL,
 Longitude DECIMAL);

-- Suite création de tables
